...
export default async function AthleteProfile({ params }: { params: Promise<{ username: string }> }) {
  ...
  const athleteQuery = supabase
    .from('profiles')
    .select('first_name, last_name, account_type, height, weight, graduating_class, gpa, sport, bio, avatar_url, hudl_highlight_url, phone_number, contact_email, instagram_url, tiktok_url, youtube_url, x_url, stats, measurables')
  ...
  const profile = athleteProfile
    ...
    : coachProfile
      ? { ...coachProfile, account_type: 'coach' as const, height: null, weight: null, graduating_class: null, gpa: null, hudl_highlight_url: null, stats: null, measurables: null }
      : null;
