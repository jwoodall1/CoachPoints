...
function EmptyState() { return <div className="surface-card px-6 py-16 text-center"><UsersRound className="mx-auto size-10 text-brand-600" /><h2 className="mt-4 text-xl font-black text-slate-950">The directory is ready for its first profile</h2><p className="mx-auto mt-2 max-w-md text-sm leading-6 text-slate-500">Complete your public profile to start building the Rosterra network.</p><Link href="/dashboard" className="btn-primary mt-6">Complete profile <ArrowRight className="size-4" /></Link></div>; }
