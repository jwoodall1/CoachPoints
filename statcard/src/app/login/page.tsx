...
function LoginForm() {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    if (isSignUp) {
      ...
      if (reservedUsernames.has(publicUsername)) { setError('That username is reserved by Rosterra. Please choose another.'); setLoading(false); return; }
