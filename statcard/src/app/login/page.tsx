...
const reservedUsernames = new Set(['api', 'coach-dashboard', 'coach-lists', 'dashboard', 'friends', 'login', 'messages', 'privacy', 'terms']);

export default function LoginPage() {
  return <Suspense fallback={<main className="loading-shell"><p>Preparing secure access…</p></main>}><LoginForm /></Suspense>;
}

/** Handles account access and requires agreement before creating an account. */
function LoginForm() {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    if (isSignUp && !acceptedTerms) { setError('Please agree to the Privacy Policy and Terms of Agreement to create an account.'); return; }
    setLoading(true);
    if (isSignUp) {
