...
const emptyProfile: Profile = { firstName: '', lastName: '', username: '', accountType: 'athlete', height: '', weight: '', graduatingClass: '', sport: '', bio: '', hudl_highlight_url: '', instagram_url: '', tiktok_url: '', youtube_url: '', x_url: '', stats: [], measurables: [] };
...
export default function DashboardPage() {
  ...
  useEffect(() => {
    const load = async () => {
      ...
      let data: { first_name?: string | null; last_name?: string | null; username?: string | null; height?: string | null; weight?: string | null; graduating_class?: string | null; sport?: string | null; bio?: string | null; avatar_url?: string | null; hudl_highlight_url?: string | null; instagram_url?: string | null; tiktok_url?: string | null; youtube_url?: string | null; x_url?: string | null; stats?: unknown; measurables?: unknown } | null = null;
      if (accountType === 'coach') {
        ...
        const result = await supabase.from('profiles').select('first_name, last_name, username, height, weight, graduating_class, sport, bio, avatar_url, hudl_highlight_url, instagram_url, tiktok_url, youtube_url, x_url, stats, measurables').eq('id', session.user.id).maybeSingle();
        data = result.data;
      }
