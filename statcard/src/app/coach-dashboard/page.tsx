...
import CoachListsPanel from '@/components/CoachListsPanel';
...
export default function CoachDashboardPage() {
  ...
  return <main className="min-h-screen bg-slate-50 px-4 py-8 sm:px-6 lg:py-12"><div className="mx-auto max-w-5xl">
    ...
    <div className="mt-8 flex justify-end"><Link href="/coach-lists" className="rounded-xl bg-emerald-600 px-5 py-3 text-sm font-semibold text-white hover:bg-emerald-700">Open full athlete lists</Link></div>
    <CoachListsPanel />
  </div></main>;
}
